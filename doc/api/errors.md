...
<a id="ERR_CONTENT_LENGTH_HEADER"></a>

### `ERR_CONTENT_LENGTH_HEADER`

When a user specifies a Content-Lenght for the header, the OutgoingMessage
throws an error when the bytes from the response are bigger than the specified
in the Content-Lenght;
