...
class X509Certificate {
  ...
  constructor(buffer) {
    ...
    this[kInternalState].set('extensions', {});
  }
  ...
  get extensions() {
    if (!this[kInternalState].has('getCertificateExtensions')) {
      this[kInternalState].set('extensions', this[kHandle].getCertificateExtensions());
    }

    return this[kInternalState].get('extensions');
  }
