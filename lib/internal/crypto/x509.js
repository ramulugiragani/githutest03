  ...
  get extensions() {
    ...
    if (value === undefined) {
      ...
      value = {
        ...
        subjectKeyIdentifier: ['DB:4B:48:2B:2B:7C:DE:94:AA:B8:33:81:13:B8:B0:22:2B:53:3B:42'],
        authorityKeyIdentifier: ['keyid:AF:0E:74:5B:9B:9A:66:51:09:DD:84:6F:4A:FF:89:6C:DA:67:DA:7F'],
        ...
        subjectAltName: ['DNS:agent1', 'DNS:www.agent1'],
        authorityInfoAccess: [infoAccessCheck],
        crlDistributionPoints: ['URI:http://crl.nodejs.org/ca.crl'],
